...
export default function QuotesDashboardClient() {
  ...
  if (error) {
    return (
      <div style={{ padding: '2rem', color: '#ef4444' }}>Error cargando dashboard: {error}</div>
    )
  }
  if (!data) {
    return <div style={{ padding: '2rem', color: '#64748b' }}>Cargando dashboard…</div>
  }
  ...
  return (
    <>
      <AdminTopbar titulo="Cotizaciones Dashboard" />
      <div style={{ padding: '24px 32px', maxWidth: 1280, margin: '0 auto' }}>
        ...
        >
          ...
          <KpiCard
            ...
            accent="#FF6B2C"
          />
          <KpiCard label="Ticket promedio" value={fmtMoney(t.avgFinalPrice)} accent="#8b5cf6" />
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 20, marginBottom: 24 }}>
          ...
          >
            ...
            <div
              style={{ display: 'flex', gap: 16, marginTop: 12, fontSize: 11, color: '#64748b' }}
            >
              <span>
                <span
                  style={{
        ...
        >
          <h2
            style={{ fontSize: 14, fontWeight: 600, color: '#0f172a', margin: 0, marginBottom: 16 }}
          >
            ...
            <tbody>
              {data.recent.map(r => (
                <tr key={r.id} style={{ borderBottom: '1px solid #f1f5f9' }}>
                  <td style={{ padding: '10px 6px', fontFamily: 'monospace', color: '#0f172a' }}>
                    {r.code}
                  </td>
