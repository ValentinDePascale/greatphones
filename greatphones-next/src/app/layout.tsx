  ...
  return (
    <html lang="es" className={`${playfair.variable} ${dmSans.variable}`} suppressHydrationWarning>
      <head>
        ...
        <link rel="preload" href="/styles/globals.css?v=3" as="style" />
        <link rel="preload" href="/styles/components.css?v=3" as="style" />
        {/* Apply critical CSS immediately */}
        <link rel="stylesheet" href="/styles/globals.css?v=3" />
        <link rel="stylesheet" href="/styles/components.css?v=3" />
        <link rel="stylesheet" href="/styles/admin.css?v=3" />
        {/* Load fonts */}
